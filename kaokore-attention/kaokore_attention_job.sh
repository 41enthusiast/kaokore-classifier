...
nb_epochs=20
python cnn-with-attention.py --train --experiment-name noreg_fl_v0_2 --arch resnet --epochs $nb_epochs --save_path experiments/attention_models --visualize --checkpoint experiments/attention_models/cnn_epoch0$nb_epochs.pth --lr 1e-4 --batch_size 8 --dropout-type NaN --dropout-p 0.2 --weight-decay 1e-3 --regularizer-type l2 --num-workers 4